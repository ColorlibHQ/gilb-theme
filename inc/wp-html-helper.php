...
// image default alt
if ( ! function_exists( 'gilb_img_default_alt' ) ) {
	function gilb_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'gilb_img_tag' ) ) {
	function gilb_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'gilb_anchor_tag' ) ) {
	function gilb_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'gilb_heading_tag' ) ) {
	function gilb_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'gilb_paragraph_tag' ) ) {
	function gilb_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'gilb_other_tag' ) ) {
	function gilb_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'gilb_button_element ' ) ) {
	function gilb_button_element( array $args ) {
