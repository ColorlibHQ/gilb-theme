 ...
 */
	...
	class gilb_Enqueue{
		...
		public function gilb_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'gilb_frontend_enqueue_scripts', ) );
		}

		public function gilb_frontend_enqueue_scripts( ){
